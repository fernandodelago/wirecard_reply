...
df_test = pd.read_sql('SELECT * FROM account_fixed_table_fee', con=db)
...
df_insert = hive.sql("""insert into wirecard.account_fixed_table_fee                         select                           id, account_id, payment_form_id, parcel_number, fixed_tax_percentual, parcel_tax_percentual, fixed_tax_value                         from tb_temp""")
