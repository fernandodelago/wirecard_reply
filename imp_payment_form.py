...
df_test = pd.read_sql('SELECT * FROM payment_form', con=db)
...
df_insert = hive.sql("""insert into wirecard.payment_form                         select                           id, name, maximum_installments                         from tb_temp""")
