...
df_test = pd.read_sql('SELECT * FROM fixed_table_fee', con=db)
...
df_insert = hive.sql("""insert into wirecard.fixed_table_fee                         select                           id, payment_form_id, parcel_number, fixed_tax_percentual, parcel_tax_percentual, fixed_tax_value                         from tb_temp""")
