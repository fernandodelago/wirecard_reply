...
df_test = pd.read_sql('SELECT * FROM account_payment_fee', con=db)
...
df_insert = hive.sql("""insert into wirecard.account_payment_fee                         select                           id, account_id, payment_form_id, fixed, antecipation_percentage, one_parcel, between_two_and_six_parcels, more_than_seven_parcels                         from tb_temp""")
